...
use crate::privacy::PrivacyDataKind;
...
/// Translate scanned and draft state separately. Absence of a pending request
/// never proves that an already-active automatic feature has done nothing.
